...
from day4.MyselfDataset.alex import *
from day4.MyselfDataset.dataset import ImageTxtDataset

# 准备数据集
train_data = ImageTxtDataset(r"/dataset/train.txt",
                             r"D:\PyCharm Project\HuaQing\dataset\Image2\train",
...
test_data = ImageTxtDataset(r"/dataset/val.txt",
                            r"D:\PyCharm Project\HuaQing\dataset\Image2\val",
                            transforms.Compose([transforms.Resize(256),
                                                transforms.ToTensor(),
                                                transforms.Normalize(mean=[0.485, 0.456, 0.406],
                                                                     std=[0.229, 0.224, 0.225])
...
for i in range(epoch):
    ...
    # 保存模型
    torch.save(chen.state_dict(), f"model_save/alex_{i}.pth")
    print("模型已保存")
